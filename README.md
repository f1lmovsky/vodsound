...
- На рекламных вставках (примерно раз в 30 минут) включается звук самого VOD, на 15-20 секунд (пока идет реклама), далее звук записи возвращается.

**Звук не синхронизирован?**
- Нажмите кнопку "Синхр" в плеере
- Настройте корректировку синхронизации, часто звуковая дорожка опережает стрим, сейчас нужно регулировать ее самостоятельно.
Обычно значения для "Корректировка синхронизации" варьируются от -9 до -11 секунд, подберите подходящее.
